    ...
    <main className="min-h-screen bg-black text-white">
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="prose prose-invert max-w-none">
          ...
          <p>
            To use certain features of the Service, you may need to register for
          ...
          <p>
            You agree to implement reasonable security measures to protect your
            API keys and the data collected through our Service.
          </p>
          ...
          <p>
            When collecting information from your users through our Service, you
            agree to:
          </p>
          <ul className="list-disc pl-6 my-4 space-y-2">
            <li>
              Provide a clear and accessible privacy policy that explains how
              you collect, use, and share user data
            </li>
            <li>
              Obtain all necessary consents for the collection and processing of
              user data
            </li>
            <li>
              Use the data collected only for the purposes disclosed to your
              users
            </li>
          ...
          <p>
            ...
            revocable license to use the Service for its intended purposes,
