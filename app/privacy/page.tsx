    ...
    <main className="min-h-screen bg-black text-white">
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="prose prose-invert max-w-none">
          ...
          <p>
            At Waitly ("we," "our," or "us"), we respect your privacy and are committed to protecting the personal
            information you provide to us. This Privacy Policy explains how we collect, use, disclose, and safeguard
            your information when you use our waitlist management service (the "Service").
          </p>
          <p>
          ...
          <p>
            This information may include your name, email address, company name, and any other information you choose to
            provide.
          </p>

          <h3 className="text-xl font-bold mt-6 mb-3">2.2 Information Collected Through Your Use of the Service</h3>
          ...
          <h3 className="text-xl font-bold mt-6 mb-3">2.3 Information Collected from Your Users</h3>
          <p>
            Through our Service, you may collect information from your users who sign up for your waitlists. This
            typically includes email addresses and any additional information you configure your waitlist to collect.
          </p>
          <p>
            You are responsible for obtaining appropriate consent from your users for the collection and processing of
            their information.
          </p>
          ...
          <p>We do not sell your personal information or the information of your users.</p>
          ...
          <p className="mt-2">Email: privacy@waitly.dev</p>
        </div>
